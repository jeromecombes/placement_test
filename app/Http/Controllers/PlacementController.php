...
class PlacementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $p->q3_11 = trim($request->q3_11);
        $p->q3_12 = trim($request->q3_12);
        $p->q3_13 = trim($request->q3_13);
        $p->q3_14 = trim($request->q3_14);
        $p->q3_15 = trim($request->q3_15);
        $p->q3_16 = trim($request->q3_16);
        $p->q3_17 = trim($request->q3_17);
        $p->q3_18 = trim($request->q3_18);
        $p->q3_19 = trim($request->q3_19);
        $p->q3_20 = trim($request->q3_20);
        ...
        $p->lastname = trim($request->lastname);
        $p->firstname = trim($request->firstname);
        $p->email = trim($request->email);
        $p->years = trim($request->years);
